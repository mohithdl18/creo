...
export default function ServicesMain() {
  ...
  return (
    <section id="services" className="w-full bg-black py-16 md:py-24 overflow-hidden">
      <div className="px-5 md:px-[80px]">
        <div className="flex items-start gap-4 md:gap-10">
          <div className="shrink-0 pt-3">
            <span className="text-[#e2e3e5] uppercase text-xs md:text-sm tracking-wide">(Services)</span>
          </div>
                ...
                {marqueeServices.map((service, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      initial={false}
                      animate={{ height: isHovered ? 520 : 400 }}
                      transition={{ duration: 0.5, ease: [0.22, 1, 0.36, 1] }}
                      className="relative overflow-hidden shrink-0 w-[200px] md:w-[280px]"
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{ backgroundColor: service.bg, opacity: isHovered ? 0.2 : 0.4 }}
                      />
                      <span
                        className="absolute top-4 left-4 text-[18px] md:text-[22px] font-medium z-20"
                      ...
                      <div
                        ...
                        style={{ backgroundColor: service.box, color: service.text }}
                      >
