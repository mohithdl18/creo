  ...
  return (
    <section className="relative w-full min-h-screen bg-black flex items-center justify-center overflow-hidden px-6 md:px-[80px]">
      ...
      <div className={`${montserrat.className} relative z-10 text-center leading-[0.9] tracking-[-0.06em]`}>
        <h1
          className={`${monoton.className} text-[#FCB724] uppercase font-normal text-[12vw] sm:text-[60px] md:text-[80px] lg:text-[120px]`}
        >
          Your &nbsp; Vision
        </h1>
        <h2 className="text-[#7a7a7a] uppercase font-medium my-6 md:my-10 text-[6vw] sm:text-[28px] md:text-[38px] lg:text-[50px]">
          is
        </h2>
        <h1
          className={`${monoton.className} text-[#e2e3e5] uppercase font-normal text-[12vw] sm:text-[60px] md:text-[80px] lg:text-[120px]`}
        >
          Our &nbsp; Mission
        </h1>
      </div>
